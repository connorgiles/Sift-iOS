...
class ArticleViewController: UIViewController {
    ...
    func addLinks(content: NSMutableAttributedString) -> NSMutableAttributedString {
        ...
        while text.length > 0 {
            ...
            if openIndex.location != NSNotFound {
                ...
                let linkText = NSMutableAttributedString(string: text.mutableString.substringWithRange(linkTextRange))
    ...
    @IBAction func recommendArticle(sender: AnyObject) {
        ...
        let upvoteRequest = GTLSiftMainUpvoteRequest()
        ...
        //Declare query
        let query = GTLQuerySift.queryForSiftApiUpvoteWithObject(upvoteRequest) as! GTLQuerySift
